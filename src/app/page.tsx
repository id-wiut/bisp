          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Find Local Tutors</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Connect with qualified tutors in your area for in-person or online sessions.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Verified Tutors</h3>
                  <p className="mt-2 text-base text-gray-500">
                    All tutors are verified and reviewed to ensure quality education.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Quick Matching</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Find the perfect tutor based on subjects, location, and availability.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-blue-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-blue-600">Find your perfect tutor today.</span>
          </h2>
